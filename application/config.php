...
return [
    ...
    // 视图输出字符串内容替换
    'view_replace_str' => [
        '__PUBLIC__' => 'http://localhost/charge/public',
        '__ROOT__' => '/',
    ],
    // 默认跳转页面对应的模板文件
    ...
    // | 小程序配置
    // +----------------------------------------------------------------------
    'APPID' => 'wx14fd8a03c8bf2694', //APPID
    'APPSECRET' => 'eb7992eabb097c63f14e566cdea3837f', //APPSECRET
    'TemplateId' => [ //模板ID配置
        'SuccessfulBookkeeping' => 'mYxKwBFeKpYXHELZ121W5o3fRAJjrbocfYnxWk1e4pI', //记账成功模板id
    ],
];
