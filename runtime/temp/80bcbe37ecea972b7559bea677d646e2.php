<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"D:\WWW\FlowShow\FlowProject\charge\public/../application/admin\view\login\login.html";i:1506418606;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>FlowAdmin后台登录</title>
...
<script type="text/javascript">
    ...
    $.ajax({
        ...
        url: "<?php echo url('login/getVerify',array('t'=>time())); ?>", // 加随机数防止缓存
        type: "get",
        dataType: "json",
