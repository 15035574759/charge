<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"D:\WWW\FlowShow\FlowProject\charge\public/../application/admin\view\menu\index.html";i:1490688537;s:86:"D:\WWW\FlowShow\FlowProject\charge\public/../application/admin\view\public\header.html";i:1490862160;s:86:"D:\WWW\FlowShow\FlowProject\charge\public/../application/admin\view\public\footer.html";i:1489835668;}*/ ?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="fhui-admin-table-container">
            <form action="/_Admin/Nav_list" class="form-horizontal" id="formrec" method="post" role="form">
                ...
                <tr>
                    ...
                    <td><?php echo $v['id']; ?></td>
                    <td style="text-align:left;"><?php if($v['pid'] == 0): ?><span class="folder-open"><i class="<?php echo $v['css']; ?>"></i></span><?php else: ?><span style="display:inline-block;width:<?php echo $v['leftpin']; ?>px;"></span><span class="folder-line"></span><?php endif; ?><?php echo $v['title']; ?></td>
